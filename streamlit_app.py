...
for col, theme in zip(cols, THEMES):
    ...
    col.markdown(
        f'<p align=center><a href="https://share.streamlit.io/{GITHUB_OWNER}/{repo}/main" target="_top"><img style="border: 1px solid {border_color}" alt="{theme}" src="https://raw.githubusercontent.com/{GITHUB_OWNER}/theming-showcase/main/thumbnails/{theme}.png" width=150></a></p>',
